...
OBJS:= hud.o background.o chunk.o debug_follower.o debug_hittable.o debug_killable.o debug_player.o drawable.o engine.o entity_handler.o gunner.o hitbox.o hitline.o hud.o hybrid_box.o image.o image_handler.o map.o map_handler.o message.o mortal.o movable.o player.o rect2d.o render.o text.o text_handler.o timeframe.o vec2d.o viewport.o weapon.o xmlnode.o xmlparse.o
