...
DEPS = background.h chunk.h debug_follower.h debug_hittable.h debug_killable.h debug_player.o drawable.h engine.h entity_handler.h gunner.h hitbox.h hitline.h hud.h hybrid_box.h image.h image_handler.h map.h map_handler.h message.h mortal.h movable.h player.h rect2d.h render.h rng.h text.h text_handler.h timeframe.h vec2d.h viewport.h weapon.h xmlnode.h xmlparse.h 

OBJS:= rng.o background.o chunk.o debug_follower.o debug_hittable.o debug_killable.o debug_player.o drawable.o engine.o entity_handler.o gunner.o hitbox.o hitline.o hud.o hybrid_box.o image.o image_handler.o map.o map_handler.o message.o mortal.o movable.o player.o rect2d.o render.o rng.o text.o text_handler.o timeframe.o vec2d.o viewport.o weapon.o xmlnode.o xmlparse.o
